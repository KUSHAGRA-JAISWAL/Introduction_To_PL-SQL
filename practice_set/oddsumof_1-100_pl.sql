/**
 * @file oddsumof_1-100_pl.sql
 * @author KUSHAGRA JAISWAL 
 * @date 2022-12-23
 * @copyright Copyright (c) 2022
 */

 /* Write a PL/SQL code to find sum of odd numbers from 1 to 100. */
...
--  here (..) means increment by 1 
    ...
    if a mod 2 != 0 
    then
--  if(a%2 != 0) means if a is odd then
...
--  end of if statement
    ...
    dbms_output.put_line('Total sum of odd numbers between 1 to 100 are : '|| c);
