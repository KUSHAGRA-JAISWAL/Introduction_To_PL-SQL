/**
 * @file evennum_1-100_pl.sql
 * @author KUSHAGRA JAISWAL 
 * @date 2022-12-22
 * @copyright Copyright (c) 2022
 */

 /* Write a PL/SQL code to print even numbers from 1 to 100. */
...
-- it means {
  ...
  dbms_output.put_line('Even numbers from 1 to 100 are: ');
  for a in 2..100
   loop
...
--  end of if statement
    ...
    dbms_output.put_line('Total number of even numbers between 1 to 100 are : '|| c);
    --  it is use to print the result just like printf()
